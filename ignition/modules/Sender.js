...
module.exports = buildModule("Sender", (m) => {
  //Wormhole contract address on the source Chain (Ethereum Sepolia) 
  ...
  //Defines the deployment of the Sender contract and pass the wormholeAddress as the only constructor parameter
